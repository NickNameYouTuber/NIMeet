...
export const ChatPanel: React.FC<ChatPanelProps> = ({
    ...
    return (
        <div className={cn(
            "fixed top-0 right-0 w-80 h-full bg-card border-l border-border shadow-lg transform transition-transform duration-300 ease-in-out z-40 flex flex-col pt-16 pb-20",
