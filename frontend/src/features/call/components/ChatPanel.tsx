...
export const ChatPanel: React.FC<ChatPanelProps> = ({
    ...
    return (
        <div className={cn(
            "fixed top-0 right-0 h-full bg-card shadow-lg transform transition-transform duration-300 ease-in-out z-40 flex flex-col",
            "w-full md:w-80",
            "md:border-l md:border-border",
            "pt-0 md:pt-16 pb-20",
            isOpen ? "translate-x-0" : "translate-x-full"
        )}>
            <div className="flex items-center justify-between px-4 py-3 md:py-2 border-b border-border">
