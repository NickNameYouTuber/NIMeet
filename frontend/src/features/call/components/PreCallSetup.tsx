                    ...
                    <div className="w-full max-w-6xl">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                            <div className="flex flex-col justify-center space-y-6 order-2 lg:order-1">
                                <div>
                                    <h2 className="text-3xl font-semibold text-white mb-2">Подготовка к встрече</h2>
                                    <p className="text-white/60 text-sm">Проверьте настройки перед подключением</p>
                                </div>

                                <div className="space-y-3">
                                    <label className="block text-sm font-medium text-white/90">Ваше имя</label>
                                    <input
                                        className="w-full bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg px-4 py-3 text-white placeholder:text-white/40 focus:outline-none focus:ring-2 focus:ring-white/20 focus:border-white/20 transition-all"
                            ...
                            <div className="order-1 lg:order-2">
                                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl overflow-hidden aspect-video relative">
                                    {cameraEnabled ? (
                                        <video
                                            ref={videoRef}
                                            autoPlay
